...
function content_69b9093b1370c1_66445312 (Smarty_Internal_Template $_smarty_tpl) {
...
" /><div class="row form-group"><label class="col-sm-3 control-label"><?php echo vtranslate('To Number',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <span class="redColor">*</span></label><div class="col-sm-5"><select class="select2 form-control" name="to_number[]" id="whatsappToNumber" data-rule-required="true" multiple="multiple"><?php
...
$_smarty_tpl->_assignInScope('RECORD_PHONE', $_smarty_tpl->tpl_vars['RECORD_PHONE_NUMBERS']->value[$_smarty_tpl->tpl_vars['FIELD_NAME']->value]);?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['PHONE_LABEL']->value;
if (!empty($_smarty_tpl->tpl_vars['RECORD_PHONE']->value)) {?>: <?php echo $_smarty_tpl->tpl_vars['RECORD_PHONE']->value;
}?></option><?php
}
...
</label><div class="col-sm-8"><input type="file" name="whatsapp_media" id="whatsappMedia" class="form-control" accept=".jpg, .jpeg, .png, .webp, .pdf, .txt, .doc, .docx, .ppt, .pptx, .xls, .xlsx, .mp4, .3gp, .aac, .mpeg, .amr, .ogg, .opus" /><span class="help-block"><small>Images, Documents, Video</small></span></div></div><div class="row form-group"><label class="col-sm-3 control-label"><?php echo vtranslate('Message',$_smarty_tpl->tpl_vars['MODULE']->value);?>
