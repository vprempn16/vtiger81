<?php
/* Smarty version 4.3.2, created on 2026-04-10 08:24:33
  from '/var/www/html/vtiger81/layouts/v7/modules/ServiceCompetency/PopupContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_69d8b3c1076486_24746354',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9327c4552f5f9e5eb79272639f53c65522dc206c' => 
    array (
      0 => '/var/www/html/vtiger81/layouts/v7/modules/ServiceCompetency/PopupContents.tpl',
      1 => 1774256169,
      2 => 'file',
    ),
  ),
...
function content_69d8b3c1076486_24746354 (Smarty_Internal_Template $_smarty_tpl) {
...
" id="sortOrder"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['START_DATE']->value;?>
" id="sc_start_date"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['END_DATE']->value;?>
" id="sc_end_date"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['MANDAY']->value;?>
" id="manday"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SOURCE_RECORD']->value;?>
" id="srcRecord"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SERVICE_ID']->value;?>
" id="service_id"><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['ROLE']->value;?>
" id="role"><?php if ($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value == "Emails") {
...
$_smarty_tpl->_assignInScope('RECORD_DATA', $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRawData());?><tr class="listViewScEntries" data-id="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getId();?>
" data-selling_price="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('selling_price');?>
"  <?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'EmailTemplates') {?> data-consultantname="<?php echo $_smarty_tpl->tpl_vars['RECORD_DATA']->value['consultantname'];?>
"  data-name="<?php echo $_smarty_tpl->tpl_vars['RECORD_DATA']->value['subject'];?>
...
' <?php }
if ($_smarty_tpl->tpl_vars['GETURL']->value != '') {?> data-url='<?php $_prefixVariable1 = $_smarty_tpl->tpl_vars['GETURL']->value;
