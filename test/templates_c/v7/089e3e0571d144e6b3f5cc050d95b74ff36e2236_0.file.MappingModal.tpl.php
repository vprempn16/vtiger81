...
function content_69b908bd186340_08454589 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <div class="col-lg-8" style="padding-top: 3px;">
                                            <select class="select2 crm-field-select" name="mapping[<?php echo $_smarty_tpl->tpl_vars['VARIABLE']->value['type'];?>
                                                ...
                                                <?php if (!empty($_smarty_tpl->tpl_vars['MODULE_FIELDS']->value)) {?>
                                                    <?php $_smarty_tpl->_assignInScope('MAPPING_KEY', (($_smarty_tpl->tpl_vars['VARIABLE']->value['type']).('_')).($_smarty_tpl->tpl_vars['VAR_NAME']->value));?>
                                                    <?php
...
" <?php if ((isset($_smarty_tpl->tpl_vars['MAPPINGS']->value[$_smarty_tpl->tpl_vars['MAPPING_KEY']->value])) && $_smarty_tpl->tpl_vars['MAPPINGS']->value[$_smarty_tpl->tpl_vars['MAPPING_KEY']->value]['crm_field'] == $_smarty_tpl->tpl_vars['FIELD_NAME']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['FIELD_LABEL']->value;?>
</option>
                                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
