<?php
/* Smarty version 4.3.2, created on 2025-11-25 13:41:59
  from '/var/www/html/vtiger81/layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6925b2273bbe77_14080680',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4478635b39273db21a52a6ef8f86d86a6d660b22' => 
    array (
      0 => '/var/www/html/vtiger81/layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl',
      1 => 1693558649,
      2 => 'file',
    ),
  ),
...
function content_6925b2273bbe77_14080680 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/vtiger81/vendor/smarty/smarty/libs/plugins/modifier.explode.php','function'=>'smarty_modifier_explode',),1=>array('file'=>'/var/www/html/vtiger81/vendor/smarty/smarty/libs/plugins/modifier.count.php','function'=>'smarty_modifier_count',),));
?>
...
if ($_smarty_tpl->tpl_vars['MODULE']->value != 'Vtiger' || $_smarty_tpl->tpl_vars['REQ']->value['view'] != 'Index') {
...
$_smarty_tpl->_assignInScope('URL', (($_smarty_tpl->tpl_vars['URL']->value).('&parent=')).($_smarty_tpl->tpl_vars['REQ']->value['parent']));
}
}?><span class="current-filter-name settingModuleName filter-name pull-left"><?php if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Calendar') {
if ($_smarty_tpl->tpl_vars['REQ']->value['mode'] == 'Edit') {?><a href="<?php echo ((((("index.php?module=").($_smarty_tpl->tpl_vars['REQ']->value['module'])).('&parent=')).($_smarty_tpl->tpl_vars['REQ']->value['parent'])).('&view=')).($_smarty_tpl->tpl_vars['REQ']->value['view']);?>
"><?php ob_start();
...
} elseif ($_smarty_tpl->tpl_vars['REQ']->value['view'] != 'List' && $_smarty_tpl->tpl_vars['REQ']->value['module'] == 'Users') {
if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'PreferenceEdit') {?><a href="<?php echo ((((("index.php?module=").($_smarty_tpl->tpl_vars['REQ']->value['module'])).('&parent=')).($_smarty_tpl->tpl_vars['REQ']->value['parent'])).('&view=PreferenceDetail&record=')).($_smarty_tpl->tpl_vars['REQ']->value['record']);?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;</a><a href=""><span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 :&nbsp;<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->getName();?>
</a><?php } elseif ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Edit' || $_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Detail') {?><a href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
"><?php if ($_smarty_tpl->tpl_vars['REQ']->value['extensionModule']) {
echo $_smarty_tpl->tpl_vars['REQ']->value['extensionModule'];
} else {
ob_start();
echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;
$_prefixVariable4 = ob_get_clean();
echo vtranslate($_prefixVariable4,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);
}?>&nbsp;</a><a href=""><span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Edit') {
...
} elseif ($_smarty_tpl->tpl_vars['URL']->value && strpos($_smarty_tpl->tpl_vars['URL']->value,$_smarty_tpl->tpl_vars['REQ']->value['view']) == '') {?><a href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
"><?php if ($_smarty_tpl->tpl_vars['REQ']->value['extensionModule']) {
echo $_smarty_tpl->tpl_vars['REQ']->value['extensionModule'];
} else {
ob_start();
...
if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Edit') {
echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 :&nbsp;<?php }
echo $_smarty_tpl->tpl_vars['RECORD']->value->getName();
}?></a><?php } else { ?>&nbsp;<?php if ($_smarty_tpl->tpl_vars['REQ']->value['extensionModule']) {
echo $_smarty_tpl->tpl_vars['REQ']->value['extensionModule'];
} else {
ob_start();
echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;
...
if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'TaxIndex') {
$_smarty_tpl->_assignInScope('SELECTED_MODULE', 'LBL_TAX_MANAGEMENT');
} elseif ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'TermsAndConditionsEdit') {
