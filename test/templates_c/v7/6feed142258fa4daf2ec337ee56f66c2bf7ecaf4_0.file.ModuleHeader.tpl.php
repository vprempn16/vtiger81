<?php
/* Smarty version 4.3.2, created on 2025-11-25 13:45:57
  from '/var/www/html/vtiger81/layouts/v7/modules/ServiceCompetency/ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6925b315824849_21282642',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6feed142258fa4daf2ec337ee56f66c2bf7ecaf4' => 
    array (
      0 => '/var/www/html/vtiger81/layouts/v7/modules/ServiceCompetency/ModuleHeader.tpl',
      1 => 1764078134,
      2 => 'file',
    ),
  ),
...
function content_6925b315824849_21282642 (Smarty_Internal_Template $_smarty_tpl) {
...
-module-action-content"><div class="col-lg-7 col-md-6 col-sm-5 col-xs-11 padding0 module-breadcrumb module-breadcrumb-<?php echo $_smarty_tpl->tpl_vars['REQ']->value['view'];?>
...
if ((isset($_smarty_tpl->tpl_vars['RECORD']->value)) && $_smarty_tpl->tpl_vars['RECORD']->value && $_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Edit') {?><p class="current-filter-name filter-name pull-left "><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
">&nbsp;&nbsp;<?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php } elseif ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Edit') {?><p class="current-filter-name filter-name pull-left "><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADDING_NEW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;</a></p><?php }
if ($_smarty_tpl->tpl_vars['REQ']->value['view'] == 'Detail') {?><p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('servicename');?>
