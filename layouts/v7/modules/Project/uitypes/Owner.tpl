{* Project-specific Owner field template.
   Uses pre-filtered FIELD_INFO picklist values from Project_Edit_View and avoids
   core accessible-user masking that can hide hierarchy-allowed users. *}
{strip}
