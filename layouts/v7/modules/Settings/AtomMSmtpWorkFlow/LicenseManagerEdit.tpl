...
{strip}
	<div class="editViewPageDiv editViewContainer" id="EditViewOutgoing" style="padding-top:0px;">
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div>
				<h3 style="margin-top: 0px;">{vtranslate('Atom MSmtp Workflow License Manager', $QUALIFIED_MODULE)}</h3>&nbsp;
			</div>
			...
			<form id="LicenseManagerConfig" data-detail-url="{$LSITVIEWURL}" method="POST">
                ...
                <input type="hidden" name="module" value="AtomMSmtpWorkFlow"/>
				...
				<div class="blockData">
					...
					<div class="block">
						<div>
							<h4>{vtranslate('Atom MSmtp Workflow License Manager', $QUALIFIED_MODULE)}</h4>
						</div>
						<hr>
                        {if $LICENSE_KEY neq ''}
								...
								<tr>
									...
									<td class="{$WIDTHTYPE} fieldValue" style="width:70%;" >
										<div class=" col-lg-6 col-md-6 col-sm-12">
											<input type="text" {if $API_KEY neq ''} placeholder="{$APIKEY}" {/if} name="msmtpworkflow_license_key" value="" class="inputElement" name="from_email_field" data-rule-email="true" data-rule-illegal="true" />
