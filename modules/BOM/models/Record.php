 ...
 */
class BOM_Record_Model extends Inventory_Record_Model {
	...
	function getPopupUrl(){
		return "index.php?module=BOM&view=generatePOPopup&recordid=".$this->getId();
	}
	function getCreateSalesOrderUrl() {
                $purchaseOrderModuleModel = Vtiger_Module_Model::getInstance('SalesOrder');
