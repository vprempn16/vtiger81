...
<?php 
class TSWhatsapp_ChatPanel_View extends Vtiger_Index_View {
    ...
    function process(Vtiger_Request $request) {
        ...
        //echo'<pre>';print_r($recordModel->getData());die;
	...
	$module_relation = true;
        ...
        $viewer->view('ChatPanel.tpl', $moduleName);
    }
